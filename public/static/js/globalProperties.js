...
var globalProperties = {
  ...
  getCurrentEnv: function () {
    var t = "local";
    return 0 == location.host.indexOf("f") || -1 < location.href.indexOf("reachtest") ? t = "dev" : 0 == location.host.indexOf("t") || -1 < location.href.indexOf("reach_dist") ? t = "test" : -1 < location.href.indexOf("pre_") ? t = "pre" : -1 < location.href.indexOf("pro_") && (t = "pro"), t
  },
